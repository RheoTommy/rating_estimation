...
from src.data_preparation.compile import prepare_assemblers, start_docker, stop_docker
...
print(
    "Make sure that these directories exist: [csv, json, pickle, source_codes, assembler]"
)
