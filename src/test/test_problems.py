...
def test_is_during_contest():
    queries = [("abc221", 1633181189), ("abc221", 1633184965), ("abc218", 1631367447), ("abc218", 1631515804)]
    expect = [True, False, True, False]
    assert is_during_contest(queries) == expect


def test_get_difficulty():
    queries = ["abc221_a", "abc221_b", "abc221_c", "abc221_d", "abc221_e", "abc221_f", "abc221_g", "abc221_h"]
